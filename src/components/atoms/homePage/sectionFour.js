...
export default function sectionFour() {
  return (
      ...
      >
        ...
        <Typography sx={{pt: 4, fontWeight: 400}} variant="subtitle1"  component="div">
        ...
        <Typography sx={{pt: 2, fontWeight: 400}}  variant="subtitle1"  component="div">
          <Typography sx={{pt: 2, fontWeight: 500,}}  variant="subtitle1"  component="span">
        ...
        <Typography sx={{pt: 2, fontWeight: 400}}  variant="subtitle1" gutterBottom component="div">
